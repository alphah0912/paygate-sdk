...
public class PayRequest {
    ...
    public String getReferenceBuyerId() { return referenceBuyerId; }
    /** @return buyer phone number (optional) */
    public String getBuyerPhoneNo() { return buyerPhoneNo; }
    /** @return payment method detail (optional) */
    public String getPaymentMethod() { return paymentMethod; }
    /** @return available payment method (optional) */
    public String getAvailablePaymentMethod() { return availablePaymentMethod; }
    /** @return saved payment methods (optional) */
    public String getSavedPaymentMethods() { return savedPaymentMethods; }
    ...
    public static class Builder {
        ...
        public Builder paymentMethodCode(String paymentMethodCode) { this.paymentMethodCode = paymentMethodCode; return this; }
        /** @param terminalType e.g. {@code "WEB"} (required) */
        public Builder terminalType(String terminalType) { this.terminalType = terminalType; return this; }
        /** @param settlementCurrency e.g. {@code "USD"} (required) */
        public Builder settlementCurrency(String settlementCurrency) { this.settlementCurrency = settlementCurrency; return this; }
        /** @param currency transaction currency (optional) */
        public Builder currency(String currency) { this.currency = currency; return this; }
        /** @param orderDescription (optional) */
        public Builder orderDescription(String orderDescription) { this.orderDescription = orderDescription; return this; }
        /** @param buyerCountry ISO country code (optional) */
        public Builder buyerCountry(String buyerCountry) { this.buyerCountry = buyerCountry; return this; }
        /** @param referenceBuyerId merchant's reference (optional) */
        public Builder referenceBuyerId(String referenceBuyerId) { this.referenceBuyerId = referenceBuyerId; return this; }
        /** @param buyerPhoneNo (optional) */
        public Builder buyerPhoneNo(String buyerPhoneNo) { this.buyerPhoneNo = buyerPhoneNo; return this; }
        ...
        public Builder availablePaymentMethod(String availablePaymentMethod) { this.availablePaymentMethod = availablePaymentMethod; return this; }
        /** @param savedPaymentMethods (optional) */
        public Builder savedPaymentMethods(String savedPaymentMethods) { this.savedPaymentMethods = savedPaymentMethods; return this; }
        ...
        public PayRequest build() {
            if (amount == null || paymentMethodCode == null || terminalType == null || settlementCurrency == null) {
                throw new IllegalArgumentException("amount, paymentMethodCode, terminalType, settlementCurrency are required");
            }
